...
export default function Dashboard() {
  ...
  const handleSubmitProduct = async (payload) => {
    ...
    try {
      ...
      if (payload.imageFiles?.length) await uploadProductImage(savedProduct.id, payload.imageFiles);
      else if (payload.imageFile) await uploadProductImage(savedProduct.id, payload.imageFile);
